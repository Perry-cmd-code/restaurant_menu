export interface MenuItem {
  ...
  export const menuEnglish: MenuItem[] = [
    ...
    // },
    // {
    //   nome: "Scampone del Mediterraneo (1° choice) 4pieces",
    //   section: SectionTypeEn.antipastiMare,
    //   price: "€ 20,00",
    // },
    {
    ...
    {
      nome: "Romana",
      description: "Tomato, Fiordilatte from Campania, ham (preservative free), origan",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 8,00"
    }, 
    {
      nome: "4 Gusti",
      description: "Tomato, fiordilatte from Campania, ham (preservative free), artichokes, origan",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    }, 
    ...
    {
      nome: "Capricciosa",
      description: "Tomato, Fiordilatte from Campania, ham (preservative free), fresh mushrooms, artichokes, olives, wurstel",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    },  
    {
      nome: "Parmigiana",
      description: "Tomato, fiordilatte from Campania, sliced ​​aubergines, fresh tomato, grated Grana Padana DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    }, 
    ...
    {
      nome: "Vegetariana",
      description: "Tomato, fresh mushrooms, sliced tomato, roasted aubergines, roasted courgettes, spinach*",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    }, 
    ...
    {
      nome: "Sicilianella",
      description: "Tomato, Fiordilatte from Campania, diced aubergines, spicy salami, anchovies, onion, bread crumbs, cacio cavallo",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    },   
    ...
    {
      nome: "4 Formaggi",
      description: "Fiordilatte from Campania, emmental, gorgonzola, grated Grana Padana DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    },
    {
      nome: "San Daniele",
      description: "Tomato, fiordilatte from Campania, rocket, Parma raw ham, flaky grain",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 10,00"
    },  
    {
      nome: "Girasole",
      description: "Tomato, fiordilatte from Campania, fresh mushrooms, mascarpone, Parma raw ham, flaky grain",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 11,00"
    },  
    ...
    {
      nome: "Chicken chips",
      description: "Tomato, fiordilatte from Campania, diced fried chicken, French fries*, BBQ sauce",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 9,00"
    },  
    ...
    },  
    {
      ...
      description: "Fiordilatte from Campania, ham (preservative free), sliced tomato, extra virgin olives oil, origan, salt",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeClassiche,
      price: "€ 8,00"
    }, 
   ...
   {
      nome: "Radicchio",
      description: "Radicchio cream, Fiordilatte from Campania, mascarpone, bresaola, grana padana flakes DOP",
      section: SectionTypeEn.pizzeria,
    ...
    {
      nome: "spinach",
      description: "Spinach cream, fiordilatte from Campania, fresh mushrooms, grated Grana Padana DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeCrema,
      price: "€ 10,00"
    },
    {
      nome: "Funghi",
      description: "Mushrooms cream, Fiordilatte from Campania, sliced tomato, speck, nuts",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeCrema,
      price: "€ 10,00"
    },
    {
    nome: "Elen",
    description: "Tuna cream, shrimp, cherry tomatoes, philadelphia, buffalo mozzarella, shrimps",
    section: SectionTypeEn.pizzeria,
    subSection: SubSectionTypeEn.pizzeCrema,
    price: "€ 13,00"
  },
  ...
  //PIZZE CON BUFALA DOP
  {
    ...
    {
      nome: "Principe",
      description: "Tomato, buffalo mozzarella, fresh mushrooms, cherry tomatoes, grana padana flakes DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeBufala,
      price: "€ 11,00"
    },
    ...
    {
      nome: "Bufalina",
      description: "Buffalo mozzarella, cherry tomatoes, Parma raw ham, grana padana flakes DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeBufala,
      price: "€ 11,00"
    },
    ...
    {
      nome: "Delicata",
      description: "Buffalo mozzarella, porcini mushrooms, cherry tomatoes, bresaola, grana padana flakes DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeBufala,
      price: "€ 12,00"
    },
    {
      nome: "Ai porcini",
      description: "Buffalo mozzarella, aubergines a dadini, mushrooms porcini, tomato, grana padana flakes DOP",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeBufala,
      price: "€ 11,00"
    },
    ...
    {
      nome: "Pistacchiosa",
      description: "Fiordilatte from Campania, mortadella, buffalo stracciatella, Pistachio pesto, morsel of buffalo, chopped pistachios",
      section: SectionTypeEn.pizzeria,
      subSection: SubSectionTypeEn.pizzeBufala,
      price: "€ 13,00"
    },
    ...
    {
    nome: "Sfilatino",
    description: "Buffalo mozzarella, Parma raw ham, cherry tomatoes, buffalo stracciatella, aubergine strips",
    section: SectionTypeEn.pizzeria,
    subSection: SubSectionTypeEn.pizzeBufala,
    price: "€ 13,00"
  },
